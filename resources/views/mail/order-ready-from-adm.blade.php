...
@section('mail-content')
    ...
    <x-mail.template.row fontsize="16" pt="8" pb="4">
        Ваш заказ поступил на склад, Вы можете забрать его в нашем центре адресу:
    </x-mail.template.row>
    <x-mail.template.row fontsize="16" pt="0" pb="10">
         <span style="font-weight: 700">{{$order->place->address}}</span>.
    </x-mail.template.row>
