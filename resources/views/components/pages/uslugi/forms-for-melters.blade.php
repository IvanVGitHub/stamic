...
<div class="wrapper-1314 d-md-none d-block">
    ...
    <div class="uslugi-text-img-block-1 d-flex mt-px-15">
        <div class="text-left mb-px-20">
            <div class="flex-grow-1">
                <div class="pl-px-10 pr-px-10 pb-px-15">
                    Мы фрезеруем формы для литья из <strong>Д16Т</strong>. Почему дюраль, а не сталь?
                    <br>
                    Наши заказчики ищут мелкосерейное литье и недорогие пресс формы. Формы из стали такими не
                    являются.
    ...
    <div class="d-flex justify-content-center mb-px-20">
        <div class="line-forms-for-melters"></div>
    </div>

    <div class="d-flex justify-content-center mb-px-20">
        <img src="{{asset('img/form with orange detail.webp')}}" class="img-form-with-orange-detail" alt="">
    </div>
    <div class="uslugi-text-img-block-1 d-flex">
        <div class="img-width-text">
            ...
            <div class="text-bottom pt-px-20 pl-px-10 pr-px-10">
                Дюраль Д16Т наиболее "выгодный" Вам вариант материала для формы. Дюраль отлично зарекомендовала себя в соотношении цена-качество. У нее большая теплопроводность, долговечность, твердость. Поэтому мы всегда рекомендуем Нашим Заказчикам выбирать именно ее .
            </div>
        </div>
    </div>
