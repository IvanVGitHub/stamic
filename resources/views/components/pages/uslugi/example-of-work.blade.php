<div class="uslugi-wide-description-work mt-md-px-85 mt-px-25">
    Как идет работа над изделием на примере пластиковой упаковки
</div>


    <div class="d-md-flex d-block uslugi-example-of-work-sequence pt-md-px-45 pt-px-20">
        <div class="uslugi-example-of-work-sequence-item">
            ...
            <div class="uslugi-example-of-work-sequence-item-under">
                ...
                <div class="pentagonal-arrow"></div>
            </div>
        </div>
        <div class="uslugi-example-of-work-sequence-item">
