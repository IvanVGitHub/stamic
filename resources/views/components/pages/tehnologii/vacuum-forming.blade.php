<div class="wrapper-1314 pt-md-px-50 pt-px-15 pb-md-px-15">
    ...
    <div class="d-md-block d-none">
        <div class="vacuum-forming-block pt-px-20">
            <div class="d-flex flex-column pb-px-15">
                <div class="flex-grow-1 list-with-title">
                    ...
                    <div class="minor-text text-size-17 pt-px-50">
                        <div class="d-flex flex-column align-items-center gray-triangle-boll vacuum-forming pr-px-30">
            ...
            <div class="vacuum-forming-wide-warm mr-px-40">
                <div class="position-relative">
                    ...
                    <div class="card-thumbnails vacuum-forming">
                        <div class="position-relative">
    ...
    <div class="d-flex d-md-none">
        <div class="pt-px-20">
            ...
            <div class="tehnologii-text">
                <div class="pt-px-10">
                    <ul>
                        <li class="pb-px-15">Нагрев осуществляется инфракрасными элементами производства Германии,</li>
                        <li class="pb-px-15">зоны нагрева регулируются при помощи семисторных регуляторов мощности,</li>
                        <li class="pb-px-15">Пневматическая система укомплектована о борудованием фирм « PNEUMAX» и «CAMOZZI», электронное управление циклами компонентами фирмы «OMRON», что в свою очередь гарантирует высокое качество аппарата, а также стабильность его работы.</li>
                    </ul>
                </div>
            </div>

                <div class="d-flex mb-3">
                    <div class="d-flex pt-px-5">
                        <img src="{{asset('img/!.png')}}" class="img-minor-text ms-2" alt="">

                            <div class="minor-text d-flex">
                                <div>
                                    Рабочее поле
                                    <br>
                                    Толщина материала
            ...
            <div style="background-color: #D1CAC5">
                <div class="d-flex justify-content-center">
                    <img class="vacuum-forming-img-phone" src="{{asset('img/box.webp')}}" alt="">
                </div>
            </div>
